...
/** Filtra por rol, por correo (si el anuncio trae lista) y por rango de vigencia [desde, hasta). */
export function anunciosVigentes(rol: AppRole, correo: string, ahora: Date = new Date()): Anuncio[] {
